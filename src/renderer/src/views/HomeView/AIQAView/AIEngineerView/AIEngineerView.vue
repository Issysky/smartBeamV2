...
<template>
  <div class="ai-production-wrapper">
    <LabelType1 :label="'工程知识助手'" :eng="'Engineering  Assistant'" />
...
// 定义buttons数组
const buttons = ref([
  { type: 'info', text: homeViewText.buttonArr[4].text, label: homeViewText.buttonArr[4].label },
  { type: 'info', text: homeViewText.buttonArr[5].text, label: homeViewText.buttonArr[5].label },
  { type: 'info', text: homeViewText.buttonArr[6].text, label: homeViewText.buttonArr[6].label },
  { type: 'info', text: homeViewText.buttonArr[7].text, label: homeViewText.buttonArr[7].label }
])
