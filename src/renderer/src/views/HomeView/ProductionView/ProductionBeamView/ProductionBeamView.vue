...
import TimeDetailAlert from './components/TimeDetailAlert.vue';

const productionBeamStore = useProductionBeamStore()

onMounted(() => {
  productionBeamStore.getBeamData({
    page_size: 10,
  })
})
</script>
<style scoped lang="less">
.production-beam-data-wrapper {
  width: 100%;
  height: 100%;
  position: relative;
  display: flex;
